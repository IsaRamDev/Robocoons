    ...
    <div className="m-o">
      ...
      <section className="gap-4 p-20 flex ">
        <div className="relative text-center px-6 py-4 rounded-lg shadow-xl overflow-hidden h-full flex flex-col items-center justify-center bg-white">
          ...
          <h2 className="text-2xl font-bold text-gray-800">Objetivo</h2>
          <p className="mt-2 text-gray-600">Ser un equipo de alto rendimiento dedicado al diseño de proyectos tecnológicos con la meta de generar un impacto positivo en la comunidad a través del uso de aplicaciones STEM.</p>
        </div>
        <div className="relative text-center px-6 py-4 rounded-lg shadow-xl overflow-hidden h-full flex flex-col items-center justify-center bg-white">
          <div className="flex items-center justify-center h-16 w-16 rounded-full mx-auto my-6 bg-black">
            <svg stroke="currentColor" fill="currentColor" viewBox="0 0 24 24" className="h-10 w-10 text-white" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
          ...
          <p className="mt-2 text-gray-600">Ser un equipo relevante y expandir el área de alcance de nuestros proyectos a un ámbito internacional para el 2024.</p>
        </div>
        <div className="relative text-center px-6 py-4 rounded-lg shadow-xl overflow-hidden h-full flex flex-col items-center justify-center bg-white">
          <div className="flex items-center justify-center h-16 w-16 rounded-full mx-auto my-6 bg-black">
          ...
          <h2 className="text-2xl font-bold text-gray-800">Alcance</h2>
